...
import { Button, Card, Dialog, DialogActions, DialogContent, DialogTitle, Grid, Slide, Typography, FormControl, Select, MenuItem, InputLabel, TextField } from "@mui/material";
...
const CreateTransactions = (props) => {
    ...
    const selectTaxOption = (data) => {
        ...
        setValue('currency', { id: data?.default_currency?.id, name: data?.default_currency?.name })
    ...
    const fetchTransactionsDetails = async () => {
        ...
        if (Transactions.data.status === "success") {
            ...
            setValue('business_account', { id: data.business_account?.id, name: data.business_account?.title });
            setValue('payment_channel', { id: data.payment_channel?.id, name: data.payment_channel?.title });
            setValue('currency', { id: data.default_currency?.id, name: data.default_currency?.name });
    ...
    return (
        <div>
            ...
            >
                <DialogTitle >{parseInt(props.editId) > 0 ? "Edit Transaction" : "Create Transaction"}</DialogTitle>
                        ...
                        <Grid container >
                            ...
                            <Grid container p={1} spacing={1} sx={{ mt: 2 }}>
                                ...
                                <Grid item xs={6}>
                                    ...
                                    <ReactSelector
                                        ...
                                        value={
                                            taxAccount.filter(options =>
                                                options.title === watch('tax_accounts')
                                            )
                                        }
                                        name='tax_accounts'
                                        // isClearable={false}
                                        defaultValue={(watch('tax_accounts'))}
                                        onChange={(selectedOption) => selectTaxOption(selectedOption)}
                                    />
                                </Grid>
                            </Grid>
                                    ...
                                    <ReactSelector
                                        ...
                                        value={
                                            paymentOptions.filter(option =>
                                                option.label === watch('payment_type'))
                                        }
                                        name='payment_type'
                                        // isClearable={true}
                                        defaultValue={(watch('payment_type'))}
                                        onChange={(selectedOption) => setValue('payment_type', selectedOption?.value || "")}
                                    />
                                </Grid>
                            ...
                            <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                ...
                                <Grid xs={6}>
                                    ...
                                    <TextInput control={control} name="businessaccount"

                                        value={watch('businessaccount')} />
                                </Grid>
                            </Grid> */}
                            ...
                            {/* <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                ...
                                <Grid xs={6}>
                                    ...
                                    <TextInput control={control} name="taxaccount"

                                        value={watch('taxaccount')} />
                                </Grid>
                            </Grid> */}
                            ...
                            {/* <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                <Grid xs={6}>
                                    <Typography variant='subtitle_1'>Type</Typography>
                                </Grid>
                                <Grid xs={6}>
                                    ...
                                    >
                                        ...
                                        <MenuItem value="3">Ledger</MenuItem>
                                    </Select>
                                </Grid>
                            </Grid>
                            ...
                            <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                ...
                                <Grid xs={6}>
                                    <SelectX
                                        ...
                                        control={control}
                                        name={'paymentchannel'}
                                        defaultValue={watch('paymentchannel')}
                                    />
                                </Grid>
                            </Grid> */}
                            ...
                            <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                ...
                                <Grid xs={6}>
                                    <SelectX
                                        ...
                                        control={control}
                                        name={'paymentprofile'}
                                        defaultValue={watch('paymentprofile')}
                                    />
                                </Grid>
                            </Grid> */}
                            ...
                            {/* <Grid sx={{ p: 1 }} item xs={12} alignItems={'center'} display={'flex'}>
                                <Grid xs={6}>
                                    <Typography variant='subtitle_1'>Payment Date</Typography>
                                </Grid>
                                <Grid xs={6}>
